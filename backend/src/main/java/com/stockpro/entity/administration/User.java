...
public class User {
    ...
    // true = l'utilisateur doit changer son login/mot de passe avant d'accéder à l'application
    // (utilisé pour les comptes temporaires créés par un administrateur, ex: compte admin initial)
